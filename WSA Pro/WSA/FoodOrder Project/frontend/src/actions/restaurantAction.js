...
export const getRestaurants = () => {
    //dispatch meas giving the order
    return async(dispatch) => {
        try{
            dispatch({type:ALL_RESTAURANTS_REQUEST});  //dispatch means giving order; IF WE R INTERACTING WITH DATA WE USE DISPATCH
        ...
        dispatch({
            ...
            payload:{restaurants,count},//payload means the data what you want to send to reducer to store
        });
        } catch(err) {
            dispatch({
