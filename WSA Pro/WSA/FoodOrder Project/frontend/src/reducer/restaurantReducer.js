import { CLEAR_ERROR, ALL_RESTAURANTS_FAIL, ALL_RESTAURANTS_REQUEST, ALL_RESTAURANTS_SUCCESS, SORT_BY_RATINGS, SORT_BY_REVIEWS, TOGGLE_VEG_ONLY } from "../constants/restaurantConstant";

const initialState={
    restaurants:[],  //it is empty bcz initially there are no restaurants
};
...
export const restaurantReducer=(state=initialState,action) => {
   switch(action.type){
    ...
    case TOGGLE_VEG_ONLY:
        return{
            ...state,
            showVegOnly : !state.showVegOnly,  //false so,!false=true
